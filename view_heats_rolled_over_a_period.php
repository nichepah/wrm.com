  ...
  <div class="row-content">
    ...
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="view_heats_rolled_over_a_period.php">View Heats Rolled Over a Period</a></li>
...
-->
    ...
    <div class="col-sm-9">
      ...
      <hr>
      <h2>View Heats Rolled Over A Period</h2>
      <h5>
...
<div class="container">
  <form action="view_heats_rolled_over_a_period.php" method="POST" target="_self">
...
$stmt2 = $conn->prepare("SELECT DISTINCT heat, grade, strand 
FROM wrm.coil
WHERE timestamp_label_print>=? and timestamp_label_print<=? 
order by heat, grade, strand");
...
echo "<h4> Report of Heats Rolled shown in : " . $result2->num_rows . " rows.</h4>";
